...
def try_methods():
    Shay=rg.SimpleTurtle()
    Shay.pen=rg.Pen("brown",5)
    Shay.forward(150)
    Shay.left(90)
    Shay.forward(50)
    Shay.backward(100)
...
def try_methods_and_functions():
    hao=rg.SimpleTurtle()
    hao.pen=rg.Pen("blue",5)
    hao.backward(150)
    hao.speed=1
    draw_many_squares(hao,2,100,30)
    hao.speed=5
    hao.pen=rg.Pen("red",5)
    draw_many_squares(hao,10,50,15)
    hao.speed=100
    hao.pen=rg.Pen("red",35)
    draw_many_squares(hao,8,300,60)
    hao.pen=rg.Pen("black",3)
    hao.backward(200)
    hao.draw_circle(30)
    hao.draw_square(50)
